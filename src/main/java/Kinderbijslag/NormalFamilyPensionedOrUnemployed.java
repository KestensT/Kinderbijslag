...
public class NormalFamilyPensionedOrUnemployed implements AgeAdditionForChildAllowance, NormalFamilySituation, UnemployedPensionedParents {

    private Child[] child;

    public NormalFamilyPensionedOrUnemployed(Child... child) {
        this.child = child;
    }
    ...
    public double calculateChildAllowanceForPensionedOrUnemployedParents(boolean isSingleParent, Child... children) {
        return calculateChildAllowancePlusAgeAddition(children) + additionForPensionsAndUnemployed(isSingleParent, children);
    }

    public double additionForPensionsAndUnemployed(boolean isSingleParent, Child... children) {
        switch (children.length) {
            ...
            default:
                ...
                return 46.88 + 29.06 + (5.10 * (children.length - 2));
        }
    }
